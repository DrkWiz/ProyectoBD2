#importar el csv a sql haciendo primero sacando las columnas Mileage_KM y Sales_Classification, 
# segundo estandarizando las columnas que tienen texto a minusculas
#  y tercero la columna de Engine_Size_L a formato float
# y cuarto poniendo la columna year en el formato dateformat: year
#y quinto poner la columna Price_USD a formato float
# y sexto poner la columna Sales_Volume a formato int
#guardando todo en un nuevo csv
import pandas as pd
